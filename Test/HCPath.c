...
CTEST(HCPath, EqualHash) {
    HCPathRef a = HCPathCreate("M 1 2 L 1 2 Q 1 2 3 4 C 1 2 3 4 5 6 Z");
    HCPathRef b = HCPathCreate("M 1 2 L 1 2 Q 1 2 3 4 C 1 2 3 4 5 6 Z");
...
CTEST(HCPath, Print) {
    HCPathRef path = HCPathCreate("M 1 2 L 1 2 Q 1 2 3 4 C 1 2 3 4 5 6 Z");
...
CTEST(HCPath, HorizontalRelativePath) {
    HCPathRef path = HCPathCreate("M 10 20 h 40");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, HorizontalPolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 H 25 50 75 90");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, HorizontalRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 h 15 25 25 15");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, VerticalPath) {
    HCPathRef path = HCPathCreate("M 10 20 V 50");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, VerticalRelativePath) {
    HCPathRef path = HCPathCreate("M 10 20 v 30");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, VerticalPolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 V 25 50 75 80");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, VerticalRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 v 5 25 25 5");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, LinePath) {
    HCPathRef path = HCPathCreate("M 10 20 L 60 80");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, LineRelativePath) {
    HCPathRef path = HCPathCreate("M 10 20 l 50 60");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, LinePolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 L 60 80 50 40 90 20");
...
CTEST(HCPath, LineRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 20 l 50 60 -10 -40 40 -20");
    ASSERT_EQUAL(HCPathElementCount(path), 4);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 20.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddLine);
...
CTEST(HCPath, QuadraticCurveRelativePath) {
    HCPathRef path = HCPathCreate("M 10 80 q 85 -70 170 0");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, QuadraticCurvePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 Q 95 10 180 80 95 150 10 80");
...
CTEST(HCPath, QuadraticCurveRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 q 85 -70 170 0 -85 70 -170 0");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, QuadraticSmoothCurvePath) {
    HCPathRef path = HCPathCreate("M 10 80 Q 52.5 10 95 80 T 180 80");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, QuadraticSmoothCurveRelativePath) {
    HCPathRef path = HCPathCreate("M 10 80 Q 52.5 10 95 80 t 85 0");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, QuadraticSmoothCurvePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 Q 52.5 10 95 80 T 180 80 95 80 10 80");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, QuadraticSmoothCurveRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 Q 52.5 10 95 80 t 85 0 -85 0 -85 0");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddQuadraticCurve);
...
CTEST(HCPath, CubicCurveRelativePath) {
    HCPathRef path = HCPathCreate("M 10 90 c 20 -80 60 -80 80 0");
    ASSERT_EQUAL(HCPathElementCount(path), 2);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 90.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicCurvePolyPath) {
    HCPathRef path = HCPathCreate("M 10 90 C 30 10 70 10 90 90 70 40 30 40 10 90");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 90.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicCurveRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 90 c 20 -80 60 -80 80 0 -20 -50 -60 -50 -80 0");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 90.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicSmoothCurvePath) {
    HCPathRef path = HCPathCreate("M 10 80 C 40 10 65 10 95 80 S 150 150 180 80");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicSmoothCurveRelativePath) {
    HCPathRef path = HCPathCreate("M 10 80 C 40 10 65 10 95 80 s 55 70 85 0");
    ASSERT_EQUAL(HCPathElementCount(path), 3);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicSmoothCurvePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 C 40 10 65 10 95 80 S 150 150 180 80 80 10 95 80 10 150 10 80");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, CubicSmoothCurveRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 80 C 40 10 65 10 95 80 s 55 70 85 0 -100 -70 -85 0 -85 70 -85 0");
    ASSERT_EQUAL(HCPathElementCount(path), 5);
    ASSERT_TRUE(HCPathElementAt(path, 0).command == HCPathCommandMove);
    ASSERT_TRUE(HCPointIsEqual(HCPathElementAt(path, 0).points[0], HCPointMake(10.0, 80.0)));
    ASSERT_TRUE(HCPathElementAt(path, 1).command == HCPathCommandAddCubicCurve);
...
CTEST(HCPath, ArcPath) {
    HCPathRef path = HCPathCreate("M 10 315 L 110 215 A 30 50 0 0 1 162.55 162.45 L 315 10");
    // TODO: Test when arcs are supported
    HCRelease(path);
}

CTEST(HCPath, ArcRelativePath) {
    HCPathRef path = HCPathCreate("M 10 315 L 110 215 a 30 50 0 0 1 52.55 -52.55 L 315 10");
    // TODO: Test when arcs are supported
    HCRelease(path);
}

CTEST(HCPath, ArcPolyPath) {
    HCPathRef path = HCPathCreate("M 10 315 L 110 215 A 30 50 0 0 1 162.55 162.45 30 50 0 0 1 162.55 162.45 L 315 10");
    // TODO: Test when arcs are supported
    HCRelease(path);
}

CTEST(HCPath, ArcRelativePolyPath) {
    HCPathRef path = HCPathCreate("M 10 315 L 110 215 a 30 50 0 0 1 52.55 -52.55 a 30 50 0 0 1 52.55 -52.55 L 315 10");
    // TODO: Test when arcs are supported
    HCRelease(path);
}

CTEST(HCPath, Path) {
    HCPathRef path = HCPathCreate("M 10 90 C 30 10 70 10 90 90 Z L 30 10 H 70 L 90 90 Q 50 10 10 90 Z");
    // TODO: Test when arcs are supported
    HCRelease(path);
}
...
CTEST(HCPath, Subpaths) {
    HCPathRef path = HCPathCreate("M 1 2 L 3 4 M 3 4 Q 5 6 7 8 L 9 0 Z M 5 6 C 7 8 9 0 1 2 Z");
